export const abi = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_treasuryGasLimit", type: "uint256" },
      {
  ...
  { inputs: [], name: "DVN_InvalidDVNIdx", type: "error" },
  {
    inputs: [{ internalType: "uint256", name: "cursor", type: "uint256" }],
    name: "DVN_InvalidDVNOptions",
    type: "error",
  },
  { inputs: [], name: "LZ_MessageLib_CannotWithdrawAltToken", type: "error" },
  {
    inputs: [
  ...
  { inputs: [], name: "LZ_MessageLib_InvalidExecutor", type: "error" },
  {
    inputs: [
  ...
  { inputs: [], name: "LZ_MessageLib_NotTreasury", type: "error" },
  { inputs: [], name: "LZ_MessageLib_OnlyEndpoint", type: "error" },
  { inputs: [], name: "LZ_MessageLib_TransferFailed", type: "error" },
  { inputs: [], name: "LZ_MessageLib_ZeroMessageSize", type: "error" },
  { inputs: [], name: "LZ_ULN_AtLeastOneDVN", type: "error" },
  {
    inputs: [{ internalType: "uint32", name: "configType", type: "uint32" }],
    name: "LZ_ULN_InvalidConfigType",
    type: "error",
  },
  { inputs: [], name: "LZ_ULN_InvalidConfirmations", type: "error" },
  { inputs: [], name: "LZ_ULN_InvalidLegacyType1Option", type: "error" },
  { inputs: [], name: "LZ_ULN_InvalidLegacyType2Option", type: "error" },
  { inputs: [], name: "LZ_ULN_InvalidOptionalDVNCount", type: "error" },
  { inputs: [], name: "LZ_ULN_InvalidOptionalDVNThreshold", type: "error" },
  { inputs: [], name: "LZ_ULN_InvalidRequiredDVNCount", type: "error" },
  {
    inputs: [{ internalType: "uint8", name: "workerId", type: "uint8" }],
  ...
  { inputs: [], name: "LZ_ULN_Unsorted", type: "error" },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint32", name: "eid", type: "uint32" },
      {
        components: [
          { internalType: "uint64", name: "confirmations", type: "uint64" },
          { internalType: "uint8", name: "requiredDVNCount", type: "uint8" },
          { internalType: "uint8", name: "optionalDVNCount", type: "uint8" },
          {
            internalType: "uint8",
            name: "optionalDVNThreshold",
            type: "uint8",
  ...
  },
  {
    inputs: [],
    name: "messageLibType",
    outputs: [{ internalType: "enum MessageLibType", name: "", type: "uint8" }],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint8", name: "endpointVersion", type: "uint8" },
    ],
    stateMutability: "pure",
    type: "function",
  },
